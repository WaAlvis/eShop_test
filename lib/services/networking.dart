...
class ProductRepository {
  ProductRepository(this.cliente);

  final Dio cliente;

  Future<List<ProductModel>> fetchProducts() async {
    final response = await cliente.get('https://winkels-strapi.herokuapp.com/products');

    print(response);

    List<ProductModel> parsedProducts = parseProducts(response.toString());
